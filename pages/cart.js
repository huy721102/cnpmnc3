            ...
            <div className="flex-[1]">
                ...
                <div className="p-5 my-5 bg-black/[0.05] rounded-xl">
                    <div className="flex justify-between">
                        ...
                        <div className="text-md md:text-lg font-medium text-black">$ 10 000.00</div>
                    </div>
                    <div className="text-sm md:text-md py-5 border-t mt-5">
                    xin chào đây là sản phẩm điện thoại oppo được ưa chuộng sử dụng nhất hiện nay
                    đây là dòng sản phẩm được mua nhiều nhất hiện nay tại shop
                    </div>
                </div>
