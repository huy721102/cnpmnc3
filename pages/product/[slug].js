  ...
  return <div className="w-full md:py-20">
    <Wrapper>
        ...
        <div className="flex-[1] py-3">
            ...
            {/* PRODUCT SUBTITLE */}
            <div className="text-lg font-semibold md-5">
                Men&apos;s Golf Shoes
            </div>
            ...
            <div className="text=md font-medium text-black/[0.5] mb-20">
                {'(Also incudes all applicable duties)'}
            </div>
            ...
            <div className="text-md mb-5">
                điện thoại oppo là dòng điện thoại 
                được ưa chuông sử dụng nhất
                hiện nay vì thế nên được nhiều người 
                thích mua sản phẩm đó đặc
                biệt là 
                sơn từng MTP đang sử dụng oppo
            </div>
            <div className="text-md mb-5">
                điện thoại oppo là dòng điện thoại 
                được ưa chuông sử dụng nhất
